...
public class AvailableSetsComposer : ComposerBase {
    ...
    public string AvailableSets { get; set; } =
        "100,105,110,115,120,125,130,135,140,145,150,155,160,165,170,175,176,177,178,180,185,190," +
    ...
    protected override async Task ComposeAsync() {
        await this.Write( $"[{this.AvailableSets}]" );
    }
}
